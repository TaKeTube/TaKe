std::optional<SampleRecord> sample_bsdf_op::operator()(const DisneyClearcoat &m) const {
...
Real sample_bsdf_pdf_op::operator()(const DisneyClearcoat &m) const {
...
Vector3 eval_material_op::operator()(const DisneyClearcoat &m) const {
